...
function CustomerLogin(){
    ...
    const UserLoginAction = e=>{
        ...
        axios.post(rest.endPointUserLogin,data,header).then(response=>{
             ...
             <div className="row">
                ...
                <div className="col s4">
                    <div className="card" style={{padding:"40px"}}>
                        <div className="" style={{textAlign:"center",fontSize:"30px"}}><b>User Login</b></div>
                        ...
                        <div class="input-field" >
                         ...
                         <input type="submit" value={"Login"} className="btn " style={{backgroundColor:"#00b0ff",width:"120px"}}></input>
                         </div>
                         <div className="" style={{textAlign:"center"}}>OR</div>
                         <div className="" style={{textAlign:"center"}}>
                            <Link className="btn" to={"/userReg"} style={{backgroundColor:"#69f0ae",width:"120px"}}>SignUp</Link>
                         </div>
                        </form>
                    </div>
                </div>
